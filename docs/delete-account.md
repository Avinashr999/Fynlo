...
Use the available reset/delete option to clear local data. If cloud sync is enabled, use the reset cloud sync option to replace or remove synced cloud data according to the in-app instructions.

## Request deletion by email

If you cannot access the app or want help deleting cloud-synced data, email:
...
Deletion requests are normally processed within 30 days. Some limited records may be retained only when required for legal, security, fraud-prevention, tax, dispute-resolution, or compliance reasons.