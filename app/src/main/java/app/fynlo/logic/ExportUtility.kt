...
object ExportUtility {
     ...
     * names with a consistent `Fynlo_Ledger_<ReportType>_<yyyy-MM-dd>_<Subject>.<ext>`
     ...
     *
     * Examples:
     *  - `Fynlo_Ledger_Report_2026-05-27_Personal.pdf`
     *  - `Fynlo_Ledger_LoanStatement_2026-05-27_Mohan_Rao.pdf`
     *  - `Fynlo_Ledger_MoneyFlow_2026-05-27_Personal.csv`
     */
    fun filename(reportType: String, subject: String, ext: String): String {
        ...
        return "Fynlo_Ledger_${reportType}_${date}_$safeSubject.$ext"
    }


    /**
     * Generated reports are the only files Fynlo Ledger shares outside the app.
    ...
    fun generatePDF(
        ...
        // Cover
        b.canvas().drawText("Fynlo Ledger", MARGIN, b.y, titlePaint())
        b.nl(26f)
        ...
        b.canvas().drawText("Generated by Fynlo Ledger v${BuildConfig.VERSION_NAME} | ${LocalDate.now()}", PAGE_W / 2f, b.y, footerPaint)
    ...
    fun generateLoanStatementPDF(
        ...
        b.canvas().drawText("Fynlo Ledger | ${LocalDate.now()}", PAGE_W / 2f, b.y, subCenter)
        b.nl(18f)
    ...
    fun generateCSV(
        ...
        sb.append("Fynlo Ledger - FINANCIAL EXPORT\n")
    ...
    fun generateDataExportCSV(
        ...
        sb.append("Fynlo Ledger - DATA EXPORT\n")
    ...
    fun generateDataExportPDF(
        ...
        val b = PdfBuilder(pdf, outputStream)
        b.startPage()
        b.text("Fynlo Ledger ${labelForDataExportScope(scope)} Export", MARGIN, titlePaint(size = 20f))
        b.nl(20f)
    ...
    fun generateMoneyFlowCSV(
        ...
        val sb = StringBuilder()
        sb.append("Fynlo Ledger - MONEY FLOW REPORT\n")
        sb.append("Generated: ${LocalDate.now()}\n\n")
